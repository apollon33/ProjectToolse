        ...
        'columns' => [
            ...
            [
                ...
                'template' => $this->render('@backend/views/layouts/_options', [
                    'options' => [
                        'update' => 'page.backend.category:' . AccessManager::UPDATE,
                        'pages' => 'page.backend.default:' . AccessManager::UPDATE,
                        'show' => 'page.backend.category:' . AccessManager::VIEW,
                        'delete' => 'page.backend.category:' . AccessManager::DELETE
                    ],
                ]),
            ],
        ],
