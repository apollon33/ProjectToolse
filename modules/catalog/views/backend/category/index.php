        ...
        'columns' => [
            ...
            [
                ...
                'template' => $this->render('@backend/views/layouts/_options', [
                    'options' => [
                        'update' => 'catalog.backend.category:' . AccessManager::UPDATE,
                        'products' => 'catalog.backend.product:' . AccessManager::UPDATE,
                        'show' => 'catalog.backend.category:' . AccessManager::VIEW,
                        'delete' => 'catalog.backend.category:' . AccessManager::DELETE
                    ],
                ]),
                'headerOptions' => ['class' => 'skip-export'],
                'contentOptions' => ['class' => 'skip-export'],
