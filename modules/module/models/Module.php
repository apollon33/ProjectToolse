...
class Module extends ActiveRecord
{
    ...
    public static function getAvailableModules()
    {
        ...
        $modules = array_filter($dbModules, function ($module) use ($user, $activeModules) {
            $accessChecker = new AccessManager();
            $modulename = strtolower($module->slug) . ':' . AccessManager::ASSIGN;
            return isset($activeModules[$module->slug]) && $accessChecker->checkAccess($user->getId(), $modulename);
        });
        return $modules;
    }
}
