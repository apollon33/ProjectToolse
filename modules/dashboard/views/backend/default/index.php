                ...
                'columns' => [
                    ...
                    [
                        ...
                        'template' => $this->render('@backend/views/layouts/_options', [
                            'options' => [
                                'update'   => 'core.backend.admin:' . AccessManager::UPDATE,
                                'activate' => 'core.backend.user:' . AccessManager::UPDATE,
            ...
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'template' => $this->render('@backend/views/layouts/_options', [
                            'options' => [
                                'update' => 'page.backend.default:' . AccessManager::UPDATE,
                                'view'   => 'page.backend.default:' . AccessManager::VIEW,
                                'delete' => 'page.backend.default:' . AccessManager::DELETE
                            ],
                        ]),
                    ],
                ],
            ...
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'template' => $this->render('@backend/views/layouts/_options', [
                            'options' => [
                                'update'   => 'catalog.backend.product:' . AccessManager::UPDATE,
                                'activate' => 'catalog.backend.product:' . AccessManager::UPDATE,
                                'delete'   => 'catalog.backend.product:' . AccessManager::DELETE
                            ],
                        ]),
                    ],
                ],
            ...
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'template' => $this->render('@backend/views/layouts/_options', [
                            'options' => [
                                'view'   => 'order.backend.default:' . AccessManager::VIEW,
                                'delete' => 'order.backend.default:' . AccessManager::DELETE
                            ],
                        ]),
                    ],
                ],
