...
//                ],
        ...
        'fileStorage' => [
            'class' => 'common\components\Storage\FileStorage',
        ],
        'filesStorage' => [
            'class' => 'common\components\Storage\FilesStorage',
        ],
        'imageStorage' => [
            'class' => 'common\components\Storage\ImageStorage',
        ],
        'authManager' => [
            'class' => 'common\rbac\DbIcoManager',
        ],
        'accessManager' => [
            'class' => 'common\access\AccessManager'
        ],
        /*'authManager' => [
