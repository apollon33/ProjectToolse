...
class m160229_160253_content_init extends Migration
{
    public function safeUp()
    {
        ...
        $this->batchInsert('{{%page}}', ['id', 'parent_id', 'user_id', 'link_name', 'slug', 'sorting', 'visible', 'title', 'meta_keywords', 'meta_description', 'header', 'content', 'created_at', 'updated_at'], [
            ...
            [11, null, 1, 'Signup', 'user/signup', 11, 3, '', '', '', '', '', 1458210079, 1458210079],
            [12, null, 1, 'Reset Password', 'user/request-password-reset', 12, 3, '', '', '', '', '', 1458210079, 1458210079],
            [13, null, 1, 'Reset Password', 'user/reset-password', 13, 1, '', '', '', '', '', 1458210079, 1458210079],
            [14, null, 1, 'Login', 'user/login', 14, 3, '', '', '', '', '', 1458210079, 1458210079],
            [15, null, 1, 'Logout', 'user/logout', 15, 2, '', '', '', '', '', 1458210079, 1458210079],
